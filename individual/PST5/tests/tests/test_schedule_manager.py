...
def fresh_manager():
    ...
    test_file = "data/data/test_data.json"
...
def test_record_payment_and_history(fresh_manager):
    ...
    fresh_manager.students.append(StudentUser(student_id_to_test, "Leonard Sovi", [101]))
...
def test_get_payment_history_no_results(fresh_manager):
    ...
    fresh_manager.students.append(StudentUser(student_id_to_test, "Jaffar kleusser", [102,103]))
